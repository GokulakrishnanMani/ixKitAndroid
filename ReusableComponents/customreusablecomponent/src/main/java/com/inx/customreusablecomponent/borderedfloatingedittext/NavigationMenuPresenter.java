...
package com.inx.customreusablecomponent.borderedfloatingedittext;
...
import com.inx.customreusablecomponent.R;
...
public class NavigationMenuPresenter implements MenuPresenter {
  ...
  final View.OnClickListener onClickListener =
      new View.OnClickListener() {
        ...
        public void onClick(View v) {
          ...
          @SuppressLint("RestrictedApi") boolean result = menu.performItemAction(item, NavigationMenuPresenter.this, 0);
  ...
  private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private void prepareMenuItems() {
      ...
      for (@SuppressLint("RestrictedApi") int i = 0, totalSize = menu.getVisibleItems().size(); i < totalSize; i++) {
        @SuppressLint("RestrictedApi") MenuItemImpl item = menu.getVisibleItems().get(i);
        if (item.isChecked()) {
          setCheckedItem(item);
        }
        if (item.isCheckable()) {
    ...
    public Bundle createInstanceState() {
      ...
      for (int i = 0, size = items.size(); i < size; i++) {
        ...
        if (navigationMenuItem instanceof NavigationMenuTextItem) {
          ...
          @SuppressLint("RestrictedApi") View actionView = item != null ? item.getActionView() : null;
          if (actionView != null) {
    ...
    public void restoreInstanceState(Bundle state) {
      ...
      if (actionViewStates != null) {
        for (int i = 0, size = items.size(); i < size; i++) {
          ...
          @SuppressLint("RestrictedApi") View actionView = item.getActionView();
          if (actionView == null) {
            continue;
          }
          @SuppressLint("RestrictedApi") ParcelableSparseArray container = actionViewStates.get(item.getItemId());
          if (container == null) {
            continue;
          }
